...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="container">
        <h1 class="mt-5">❃❃❃Comida Rapida❃❃❃</h1>
        <div class="row mt-4">
            <?php
              session_start();
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    switch ($row["nombre"]) {
                        case "Hot Dog con champiñones":
                            $imagenProducto = "hotchampiñones.jpg";
                            break;
                        case "Banderias":
                            $imagenProducto = "banderias.jpg";
                            break;
                        case "salchitocino":
                            $imagenProducto = "salchitocino.jpg";
                            break;
                        case "sushi":
                            $imagenProducto = "sushi.jpg";
                            break;
                        case "bandeja para compartir":
                            $imagenProducto = "bandeja.jpg";
                                break;
                        case "tacos dorados":
                            $imagenProducto = "tacosdorados.jpg";
                                    break;
                    }
